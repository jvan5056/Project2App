...
const algOneTopics = ['Exponents and Radicals','Expressions and Equations', 'Solving Linear Equations', 'Linear Inequalities', 
...
const algTwoTopics = ['Expressions and Equations', 'Inequalities', 'Functions', 'Systems of Equations', 'Matrices', 'Real and Complex Numbers',
...
const geoTopics = ['Points, lines, line segments, and planes', 'Angles', 'Parallel and Perpendicular lines', 'Triangles', 'Two and Three-Dimensional Figures', 
...
const precalcTopics = ['Functions', 'Systems of Equations and Inequalities', 'Matrices', 'Real and Complex Numbers',
'Quadratic Functions', 'Polynomials', 'Radical Functions', 'Rational Functions', 'Functions Operations', 'Families of Functions', 
...
const calcTopics = ['Functions', 'Families of Functions', 'Trigonometric Functions and Identities', 'Exponential and Logarithmic Functions',
 'Limits', 'Rational Functions', 'Continuity', 'Derivatives', 'Calculate Derivatives', 'Calculate Higher Derivatives']
const apCalcTopics = ['Functions', 'Families of Functions', 'Trigonometric Functions and Identities', 'Exponential and Logarithmic Functions',
...
const statsTopics = ['Statistical Definitions', 'Descriptive Statistics', 'Probability', 'Probability Distributions', 
'Inferential Statistics', 'Regression', 'Data, Graphs, and Functions', 'Regressional Analysis']
const apStatsTopics = ['Statistical Definitions', 'Descriptive Statistics', 'Probability', 'Probability Distributions', 
...
const algOneLessons = [
    ...
    let getAllAlgebraOne = () => {
        return algOneTopics
    }

    let getAllAlgebraTwo = () => {
        return algTwoTopics
    }

    let getAllPrecalc = () => {
        return precalcTopics
    }
    ...
    let getAllAlgOneLessons = () => {
        return algOneLessons
    }

    let getCourse = (index) => {
        console.log('I hit getCourse', courses[index])
